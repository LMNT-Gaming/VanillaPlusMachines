package net.mcreator.vanillaplusmachines;
...
@Mod("vanillaplusmachines")
public class VanillaplusmachinesMod {
	public static final Logger LOGGER = LogManager.getLogger(VanillaplusmachinesMod.class);
	public static final String MODID = "vanillaplusmachines";

	public VanillaplusmachinesMod(IEventBus modEventBus) {
		...
		VanillaplusmachinesModTabs.REGISTRY.register(modEventBus);
		VanillaplusmachinesModVariables.ATTACHMENT_TYPES.register(modEventBus);

		VanillaplusmachinesModMenus.REGISTRY.register(modEventBus);
