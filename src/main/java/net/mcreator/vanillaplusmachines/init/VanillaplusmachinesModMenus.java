...
public class VanillaplusmachinesModMenus {
	...
	public static final DeferredHolder<MenuType<?>, MenuType<GrinderGUIMenu>> GRINDER_GUI = REGISTRY.register("grinder_gui", () -> IMenuTypeExtension.create(GrinderGUIMenu::new));
}
